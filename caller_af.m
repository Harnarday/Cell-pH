function allvals = caller_af(x,y)
% Caller function for running cell_allflux.m with different pH values
% cell_allflux.m includes flux of OH and H to both ocean and vent.
% x is pH of ocean
% y is pH of vent
% Settings
tmax = 2000;
...
for j = 1:length(x)
    ...
    for i =1:tmax
        ...
        dx_vector(i,:) = cell_allflux(pH_vals(i,:));
